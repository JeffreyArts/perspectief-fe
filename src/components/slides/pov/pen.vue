                ...
                <div class="pen-intro-container">
                    ...
                    <div class="pen-illustration">
                        <svg viewBox="0 0 1247 367" xmlns="http://www.w3.org/2000/svg" fill="none">
                            <path class="pen-line" id="pen-line" stroke-dasharray="1244"  d="M2,331c133.1-4.8,312.7-4,409.3-4 s314.5,11.1,386.8,6.7S1093,329,1093,329" stroke-width="3" stroke-linecap="round"/>
            ...
            this.timeline = gsap.timeline({
                ...
                .to(this.$el.querySelectorAll(".svg-pen"), {
                    ...
                    onStart: () => {
                        ...
                        const target = document.querySelector(".pov-content.pen-container") as HTMLElement
                        if (!container || !target) {
                            return
                        }
